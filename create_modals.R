...
modal_3 <- modalDialog(
  title = "Grafiken bedienen",
  p("Die Daten für die beiden Gemeinden werden nebeneinander dargestellt. Die transparenten Fareben werden in der Legende durch",tags$img(src="grey.PNG")," symbolisiert, die gesättigten durch ",tags$img(src="black.PNG"),"."),
  ...
  tags$img(src = "one_gemeinde.PNG", width = "80%"),
  footer = list(actionButton("last_modal", label = "Zurück"),actionButton("next_modal", label = "Weiter"), modalButton("Schliessen")),
  fade = FALSE
...
modal_4 <- modalDialog(
  ...
  tags$img(src = "wahlbeteiligung.PNG", width = "80%"),
  footer = list(actionButton("last_modal", label = "Zurück"),actionButton("next_modal", label = "Weiter"), modalButton("Schliessen")),
  fade = FALSE
...
modal_5 <- modalDialog(
  ...
  tags$img(src = "parteistaerke.PNG", width = "80%"),
  footer = list(actionButton("last_modal", label = "Zurück"),actionButton("next_modal", label = "Weiter"), modalButton("Schliessen")),
  fade = FALSE
...
modal_6 <- modalDialog(
  ...
  tags$img(src = "veraenderung.PNG", width = "80%"),
  footer = list(actionButton("last_modal", label = "Zurück"),actionButton("next_modal", label = "Weiter"), modalButton("Schliessen")),
  fade = FALSE
...
modal_7 <- modalDialog(
  ...
  tags$img(src = "panaschier.PNG", width = "80%"),
  footer = list(actionButton("last_modal", label = "Zurück"),actionButton("next_modal", label = "Weiter"), modalButton("Schliessen")),
  fade = FALSE
